#
#  Be sure to run `pod spec lint MMX-PromiseKit.podspec' to ensure this is a
...
#  s.license      = "MIT (example)"
  ...
  s.author             = { "Seth Samuel" => "sethfsamuel@gmail.com" }
  # Or just: s.author    = "Seth Samuel"
  # s.authors            = { "Seth Samuel" => "sethfsamuel@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Seth Samuel"
  ...
  s.source_files  = "MMX-PromiseKit/**/*.{m,h,swift}"
